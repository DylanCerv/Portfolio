...
export const HERO = {
  ...
  // proof: "~30s → <500ms API latency · 1M+ records migrated · Auth architecture from scratch",
  proof: "Reduced API latency from ~30s to <500ms · Migrated 1M+ records · Designed auth architecture from scratch",
